...
public class ProductDao {
    ...
    public List<Product> findProductByName_jpa(String name) {
        List<product> productFindByName = productRepository.findByName(name);
    ...
    private Product findFullProduct_jpa(product productEntity) {
    ...
    private List<Product> findOtherProduct_jpa(product productEntity){

        List<product> otherProductEntities = productRepository.findOtherProducts(productEntity.getGoodsId(), productEntity.getId());
        ArrayList<Product> otherProducts = new ArrayList<>();
        for (product otherProductEntity : otherProductEntities) {
